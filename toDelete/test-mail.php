...
<?// mail('k1q@mail.ru','all data2',"test message"); ?>
<!-- <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="BHHYVQJJ9UDSL">
...
<form action="https://www.tstohome.com/notify.php" method="POST">
